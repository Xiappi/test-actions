...
begin
    ...
    for select rule_detail_id
          ...
          join rule_categories rc on rc.rule_category_id = rm.rule_category_id
         where csc.name in ('Prequal_RP_OP_SP')
...
insert into applied_scripts(name, description, script_date)
     values ("201203ro03", "BCSB-1397 - override prequal for underwriters", "2020-DEC-03");
