...
values (gen_id(questionnaire_id_gen, 1), 'XX', 'OP', 'PREQUAL', '01/01/1996', '12/31/9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_OP_XX_v1.js');
...
insert into applied_scripts (name, description, script_date)
     values ('200923CW01', 'BCSB-582 - Prequal for Malta OP line', '2020-September-23');
