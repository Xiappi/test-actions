...
begin
    select rule_category_id
     ...
     where rule_code = 'VALIDATE_DWELLING_CHAR_ENTRY'
      rows 1
    ...
    insert into custom_source_code (code_id, name, description, source_code, source_code_type_id)
         values (:var_code_id, 'MapLocationLatLngToDwellingForDwelling', 'Map Location LatLng to associated Property Damage.', '', :var_code_type_id);
...
insert into applied_scripts(name, description, script_date)
     values ("210902AO02", "MHM-869 - dwelling map loc latlng to dwelling", "2021-SEP-02");