...
create procedure temp_210824DC03(
...
begin
    ...
    select rule_category_id 
     ...
     where rule_code = 'VALIDATE_CHARGES_CREDITS' 
...
execute procedure temp_210824DC03('ChargesCreditReasonLookup', "Reasons is required for Discount/Load")^
 
drop procedure temp_210824DC03^
 
set term ;^

insert into applied_scripts (name, description, script_date)
     values ('210824DC03', 'MHM-734 add rule for charge credit discount/load', '2021-Aug-24');
