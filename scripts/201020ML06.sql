...
begin
    select out_code_id
      from i_model_custom_source_code('RP', 'AuthorizationLimitDeteriorationOfStock', "Food Spoilage exceeds authorized limit", '', 1, 'TODAY', 'AUTHORIZE')
      into :var_code_id;
    
    /* Food Spoilage Rules that DON'T create tasks */
    ...
    select out_detail_id
      from i_model_rule_details(:var_master_id, 'AuthorizationLimitDeteriorationOfStock', "Food Spoilage exceeds authorized limit", :var_code_id, 1, 'TODAY', 1, 1, 1, 0)
      into :var_detail_id;

    select out_auth_limit_id
      from tmp_create_limits(:var_detail_id, 10001, 25000, 'MGMTSR', 'UWSR', 'UW', null)
      into :var_auth_limit_id;

    select out_auth_limit_id
      from tmp_create_limits(:var_detail_id, 25001, 40000, 'MGMTSR', 'UWSR', null, null)
      into :var_auth_limit_id;

    /* Food Spoilage Rules that create tasks */
    select rule_category_id
      from rule_categories
    ...
    select out_detail_id
      from i_model_rule_details(:var_master_id, 'AuthorizationLimitDeteriorationOfStock_Notify', "Food Spoilage exceeds authorized limit", :var_code_id, 1, 'TODAY', 1, 1, 1, 0)
      into :var_detail_id;
    ...
    select activity_id
      from task_activity
     where activity_name = 'DETERIORATIONOFSTOCK_UW' rows 1
    ...
    select activity_id
      from task_activity
     where activity_name = 'DETERIORATIONOFSTOCK_UWSR' rows 1
      into :var_activity_id;
...
insert into task_activity (task_title, default_number_of_days_due, task_message, activity_name, web_link, notify_agent, notify_creator, category_name)
     values ("Food Spoilage exceeds 10,000", 5, "An application has been submitted with food spoilage coverage over 10,000 that needs your review.", 'DETERIORATIONOFSTOCK_UW', null, 1, 1, 'DETSTOCK')^
 
insert into task_activity (task_title, default_number_of_days_due, task_message, activity_name, web_link, notify_agent, notify_creator, category_name) 
     values ("Food Spoilage exceeds 25,000", 5,  "An application has been submitted with food spoilage coverage over 25,000 that needs your review.", 'DETERIORATIONOFSTOCK_UWSR', null, 1, 1, 'DETSTOCK')^
...
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UW', 'AG')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UW', 'UW')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UW', 'UWSR')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UW', 'MGMTSR')^
execute procedure temp_create_edit_activity_right('DETERIORATIONOFSTOCK_UW', 'UW')^
execute procedure temp_create_edit_activity_right('DETERIORATIONOFSTOCK_UW', 'UWSR')^
execute procedure temp_create_edit_activity_right('DETERIORATIONOFSTOCK_UW', 'MGMTSR')^

execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UWSR', 'AG')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UWSR', 'UW')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UWSR', 'UWSR')^
execute procedure temp_create_view_activity_right('DETERIORATIONOFSTOCK_UWSR', 'MGMTSR')^
execute procedure temp_create_edit_activity_right('DETERIORATIONOFSTOCK_UWSR', 'UWSR')^
execute procedure temp_create_edit_activity_right('DETERIORATIONOFSTOCK_UWSR', 'MGMTSR')^
...
insert into applied_scripts (name, description, script_date)
     values ('201020ML06', 'RT-161 - auth level for spoilage', '2020-Sept-20');