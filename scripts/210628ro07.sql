set term ^;
create procedure temp_my_prequal
as
...
begin
  ...
  insert into questionnaire values(:qid, 'XX', 'MY', 'PREQUAL', :effdate, '31-DEC-9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_MY_XX_v1.js');
...
execute procedure temp_my_prequal^

commit^

drop procedure temp_my_prequal^

commit^

insert into applied_scripts(name, description, script_date)
values ("210628ro07", "MHM-471 Add ArgusMT MY prequal questionnaire", "2021-JUN-28")^
set term ;^
commit work;
