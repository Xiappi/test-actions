...
values (gen_id(questionnaire_id_gen, 0), 'XX', 'RP', 'PREQUAL', '01/01/1996', '12/31/9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_RP_XX_v1.js');


insert into question 
values (
    gen_id(question_id_gen, 0),
    'PREQUAL',
...
insert into applied_scripts (name, description, script_date)
     values ('200715CW01', 'BCSB-204 - Malta RP prequal', '2020-JULY-07');
