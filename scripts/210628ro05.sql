set term ^;
create procedure temp_cv_prequal
as
...
begin
  ...
  insert into questionnaire values(:qid, 'XX', 'CV', 'PREQUAL', :effdate, '31-DEC-9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_CV_XX_v1.js');
...
execute procedure temp_cv_prequal^

commit^

drop procedure temp_cv_prequal^

commit^

insert into applied_scripts(name, description, script_date)
values ("210628ro05", "MHM-469 Add ArgusMT CV prequal questionnaire", "2021-JUN-28")^
set term ;^
commit work;
