...
create procedure temp_insert_value_201028jb02
as
...
begin
    ...
    begin
        ...
        begin
            select out_id
              from i_model_company_config_section(:var_config_master_id, 'ADDITIONAL', 'Additional locations', 'Configure additional locations behavior')
              into :var_config_section_id;
        end
        
        select out_id
          from i_model_company_config_value(:var_config_section_id, 'STATETYPE', 'MULTISTATE', 'LIST', 0, 0, 'MULTISTATE', 'Set state/province selection', '', '', null)
...
execute procedure temp_insert_value_201028jb02^

commit^

drop procedure temp_insert_value_201028jb02^
...
insert into applied_scripts (name, description, script_date)
     values ('201028jb02', 'BCSB-959 company config for add locs', '2020-October-28');
