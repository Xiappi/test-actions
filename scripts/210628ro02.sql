set term ^;
create procedure temp_pc_prequal
as
...
begin
  ...
  insert into questionnaire values(:qid, 'XX', 'PC', 'PREQUAL', :effdate, '31-DEC-9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_PC_XX_v1.js');
...
execute procedure temp_pc_prequal^

commit^

drop procedure temp_pc_prequal^

commit^

insert into applied_scripts(name, description, script_date)
values ("210628ro02", "MHM-53 Add ArgusMT PC prequal questionnaire", "2021-JUN-28")^
set term ;^
commit work;
