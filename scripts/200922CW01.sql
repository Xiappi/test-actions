set generator question_id_gen to 0;

set generator questionnaire_id_gen to 0;
...
values (gen_id(questionnaire_id_gen, 1), 'XX', 'RP', 'PREQUAL', '01/01/1996', '12/31/9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_RP_XX_v1.js');
...
insert into applied_scripts (name, description, script_date)
     values ('200922CW01', 'BCSB-546 - Update Malta RP prequal', '2020-September-22');
