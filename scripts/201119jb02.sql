...
execute procedure tmp_insert_auth_limit('RP', 'AuthorizationLimitProductsLiability', 500001, 2000000, 'PRODUCTLIABILITY_UWSR', 'UWSR', 'UWMGR', 'MGMTSR', null)^
execute procedure tmp_insert_auth_limit('RP', 'AuthorizationLimitProductsLiability', 500001, 2000000, null, 'UWSR', 'UWMGR', 'MGMTSR', null)^
execute procedure tmp_insert_auth_limit('RP', 'AuthorizationLimitProductsLiability', 2000001, 5000000, 'PRODUCTLIABILITY_MGMTSR', 'MGMTSR', null, null, null)^
execute procedure tmp_insert_auth_limit('RP', 'AuthorizationLimitProductsLiability', 2000001, 5000000, null, 'MGMTSR', null, null, null)^
...
insert into applied_scripts(name, description, script_date)
     values ("201119jb02", "BCSB-1804 updating RP auth rule limits", "2020-NOV-19");