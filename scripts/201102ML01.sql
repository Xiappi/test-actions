...
create procedure tmp_clone_stamp_duty(in_line varchar(2))
as
...
begin
    ...
    insert into ref_table (reftable_id, ref_code, state, ref_key, ref_desc, rate_modifier, prior_modifier, qty, descr, endorsement, mobile_home,
         ...
         select :var_new_id, rt1.ref_code, rt1.state, 'NEW', rt1.ref_desc, rt1.rate_modifier, rt1.prior_modifier, rt1.qty, rt1.descr, rt1.endorsement, rt1.mobile_home, 
                ...
                rt1.show_type, rt1.one_only, rt1.gl_account, rt1.account_no, 13.00, rt1.list_labels, rt1.new_orig_comm, rt1.new_change_comm, 
    ...
    insert into ref_table (reftable_id, ref_code, state, ref_key, ref_desc, rate_modifier, prior_modifier, qty, descr, endorsement, mobile_home,
         ...
         select :var_new_id, rt2.ref_code, rt2.state, 'CHANGE', rt2.ref_desc, rt2.rate_modifier, rt2.prior_modifier, rt2.qty, rt2.descr, rt2.endorsement, rt2.mobile_home, 
                ...
                rt2.show_type, rt2.one_only, rt2.gl_account, rt2.account_no, 2.33, rt2.list_labels, rt2.new_orig_comm, rt2.new_change_comm, 
    ...
    insert into ref_table (reftable_id, ref_code, state, ref_key, ref_desc, rate_modifier, prior_modifier, qty, descr, endorsement, mobile_home,
         ...
         select :var_new_id, rt3.ref_code, rt3.state, 'RENEW', rt3.ref_desc, rt3.rate_modifier, rt3.prior_modifier, rt3.qty, rt3.descr, rt3.endorsement, rt3.mobile_home, 
                ...
                rt3.show_type, rt3.one_only, rt3.gl_account, rt3.account_no, 13.00, rt3.list_labels, rt3.new_orig_comm, rt3.new_change_comm, 
...
execute procedure tmp_clone_stamp_duty('RP')^
execute procedure tmp_clone_stamp_duty('SP')^
execute procedure tmp_clone_stamp_duty('OP')^
...
drop procedure tmp_clone_stamp_duty^

set term ;^

insert into applied_scripts (name, description, script_date)
     values ('201102ML01', 'BCSB-955 - 3 entries for stampduty (new, change, renew)', '2020-Nov-02');