set term ^;
create procedure temp_tx_prequal
as
...
begin
  ...
  insert into questionnaire values(:qid, 'XX', 'TX', 'PREQUAL', :effdate, '31-DEC-9999', 'A', 'Clients/ArgusMT/Scripts/Questionnaire/PrequalQuestionnaire_TX_XX_v1.js');
...
execute procedure temp_tx_prequal^

commit^

drop procedure temp_tx_prequal^

commit^

insert into applied_scripts(name, description, script_date)
values ("210628ro04", "MHM-472 Add ArgusMT TX prequal questionnaire", "2021-JUN-28")^
set term ;^
commit work;
