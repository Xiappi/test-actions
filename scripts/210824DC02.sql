...
create procedure temp_210824DC02(
...
begin
    ...
    select rule_category_id 
     ...
     where rule_code = 'VALIDATE_ITEM_ENTRY' 
...
execute procedure temp_210824DC02('ItemReasonLookup', "Reasons is required for Discount/Load")^
 
drop procedure temp_210824DC02^
 
set term ;^

insert into applied_scripts (name, description, script_date)
     values ('210824DC02', 'MHM-734 add rules for item discount/load', '2021-Aug-24');
