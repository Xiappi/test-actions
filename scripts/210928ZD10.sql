...
begin
	...
	INSERT INTO QUESTIONNAIRE
		values (:var_qid, "XX", "HR", "APPLICATION", "01.01.2001", "31.12.9999", "A", "Clients/ArgusMT/Scripts/Questionnaire/ApplicationQuestionnaire_HR_XX_v1.js");
	...
	INSERT INTO QUESTION 
		 VALUES (:var_quid, 'APPLICATION', 
				 ...
				 NULL, 'TRUE', 'A', 'VALID_LICENSE_HR', '', NULL, NULL);
    ...
    insert into question
         values (:var_quid, 'APPLICATION',
                 'Please explain.',
                 'MEMO', null,
                 null, 'FALSE', 'A', 'VALID_LICENSE_NO_HR', '', null, null);
    insert into questionnaire_question
	...
	INSERT INTO QUESTION 
		 VALUES (:var_quid, 'APPLICATION', 
				 ...
				 'SECTION', null, 
				 NULL, 'TRUE', 'FALSE', 'WHO_WILL_DRIVE_HR', '', NULL, NULL);
	insert into questionnaire_question
	...
	INSERT INTO QUESTION 
		 VALUES (:var_quid, 'APPLICATION', 
				 ...
				 'BUTTON', '[{"Selected": false, "Text": "Yes", "Value": "Y" }, {"Selected": false, "Text": "No", "Value": "N"}]', 
				 NULL, 'TRUE', 'A', 'CONDITION_HR', '', NULL, NULL);
	insert into questionnaire_question
    ...
    insert into question
         values (:var_quid, 'APPLICATION',
                 'Please explain.',
                 'MEMO', null,
                 null, 'FALSE', 'A', 'CONDITION_YES_HR', '', null, null);
    insert into questionnaire_question
	...
	INSERT INTO QUESTION 
		 VALUES (:var_quid, 'APPLICATION', 
				 ...
				 'BUTTON', '[{"Selected": false, "Text": "Yes", "Value": "Y" }, {"Selected": false, "Text": "No", "Value": "N"}]', 
				 NULL, 'TRUE', 'A', 'EYESIGHT_HR', '', NULL, NULL);
	insert into questionnaire_question
    ...
    insert into question
         values (:var_quid, 'APPLICATION',
                 'Please explain.',
                 'MEMO', null,
                 null, 'FALSE', 'A', 'EYESIGHT_YES_HR', '', null, null);
    insert into questionnaire_question
	...
	INSERT INTO QUESTION 
		 VALUES (:var_quid, 'APPLICATION', 
				 ...
				 'BUTTON', '[{"Selected": false, "Text": "Yes", "Value": "Y" }, {"Selected": false, "Text": "No", "Value": "N"}]', 
				 NULL, 'TRUE', 'A', 'PENALTY_HR', '', NULL, NULL);
	insert into questionnaire_question
    ...
    insert into question
         values (:var_quid, 'APPLICATION',
                 'Please explain.',
                 'MEMO', null,
                 null, 'FALSE', 'A', 'PENALTY_YES_HR', '', null, null);
    insert into questionnaire_question
...
insert into applied_scripts (name, description, script_date)
     values ("210928ZD10", "MHM-151 HR app questionnaire", "2021-SEP-28");
commit work;