...
create procedure temp_210929DC01(
...
execute procedure temp_210929DC01('HomeProtectorExtraDeclaration_HX', "An unexpected error occurred while generating the report.")^
 
drop procedure temp_210929DC01^
