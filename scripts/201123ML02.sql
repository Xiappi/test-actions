...
begin
    select out_code_id
      from i_model_custom_source_code('AuthorizationLimitBusinessInterruption', "Business Interruption exceeds authorized limit", '', 1, 'TODAY', 'AUTHORIZE')
      into :var_code_id;
...
insert into task_activity (task_title, default_number_of_days_due, task_message, activity_name, web_link, notify_agent, notify_creator, category_name)
     values ("Business Interruption exceeds Broker limit", 5, "An application has been submitted with Business Interruption that requires Underwriter review.", 'BUSINESSINTERRUPT_UW', null, 1, 1, 'BINTERRUPT')^
...
execute procedure temp_create_view_activity_right('BUSINESSINTERRUPT_UW', 'AG')^
execute procedure temp_create_view_activity_right('BUSINESSINTERRUPT_UW', 'UW')^
execute procedure temp_create_view_activity_right('BUSINESSINTERRUPT_UW', 'UWSR')^
execute procedure temp_create_view_activity_right('BUSINESSINTERRUPT_UW', 'UWMGR')^
execute procedure temp_create_view_activity_right('BUSINESSINTERRUPT_UW', 'MGMTSR')^

execute procedure temp_create_edit_activity_right('BUSINESSINTERRUPT_UW', 'UW')^
execute procedure temp_create_edit_activity_right('BUSINESSINTERRUPT_UW', 'UWSR')^
execute procedure temp_create_edit_activity_right('BUSINESSINTERRUPT_UW', 'UWMGR')^
execute procedure temp_create_edit_activity_right('BUSINESSINTERRUPT_UW', 'MGMTSR')^
...
insert into applied_scripts(name, description, script_date)
     values ("201123ML02", "RT-178 - inserted missing rules", "2020-NOV-23");