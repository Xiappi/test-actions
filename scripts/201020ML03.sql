...
begin
    select out_code_id
      from i_model_custom_source_code('RP', 'AuthorizationLimitMoneyLockedSafe', "Money in Locked Safe or Strongroom Outside Business Hours exceeds authorized limit", '', 1, 'TODAY', 'AUTHORIZE')
      into :var_code_id;
    
    /* Money in Locked Safe or Strongroom Outside Business Hours Rules that DON'T create tasks */
    ...
    select out_detail_id
      from i_model_rule_details(:var_master_id, 'AuthorizationLimitMoneyLockedSafe', "Money in Locked Safe or Strongroom Outside Business Hours exceeds authorized limit", :var_code_id, 1, 'TODAY', 1, 1, 1, 0)
      into :var_detail_id;

    select out_auth_limit_id
      from tmp_create_limits(:var_detail_id, 10000, 25000, 'UW', 'UWSR', 'MGMTSR', null)
      into :var_auth_limit_id;

    select out_auth_limit_id
      from tmp_create_limits(:var_detail_id, 25001, 250000, 'MGMTSR', null, null, null)
      into :var_auth_limit_id;

    /* Money in Locked Safe or Strongroom Outside Business Hours Rules that create tasks */
    select rule_category_id
      from rule_categories
    ...
    select out_detail_id
      from i_model_rule_details(:var_master_id, 'AuthorizationLimitMoneyLockedSafe_Notify', "Money in Locked Safe or Strongroom Outside Business Hours exceeds authorized limit", :var_code_id, 1, 'TODAY', 1, 1, 1, 0)
      into :var_detail_id;
    ...
    select activity_id
      from task_activity
     where activity_name = 'MONEYLOCKEDSAFE_UW' rows 1
    ...
    select activity_id
      from task_activity
     where activity_name = 'MONEYLOCKEDSAFE_MGMTSR' rows 1
      into :var_activity_id;
...
insert into task_activity (task_title, default_number_of_days_due, task_message, activity_name, web_link, notify_agent, notify_creator, category_name)
     values ("Money in Locked Safe or Strongroom Outside Business Hours exceeds 10,000", 5, "An application has been submitted with money in locked safe or strongroom outside business hours coverage over 10,000 that needs your review.", 'MONEYLOCKEDSAFE_UW', null, 1, 1, 'MONEY')^ 
 
insert into task_activity (task_title, default_number_of_days_due, task_message, activity_name, web_link, notify_agent, notify_creator, category_name) 
     values ("Money in Locked Safe or Strongroom Outside Business Hours exceeds 25,000", 5,  "An application has been submitted with money in locked safe or strongroom outside business hours coverage over 25,000 that needs your review.", 'MONEYLOCKEDSAFE_MGMTSR', null, 1, 1, 'MONEY')^
...
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_UW', 'AG')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_UW', 'UW')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_UW', 'UWSR')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_UW', 'MGMTSR')^
execute procedure temp_create_edit_activity_right('MONEYLOCKEDSAFE_UW', 'UW')^
execute procedure temp_create_edit_activity_right('MONEYLOCKEDSAFE_UW', 'UWSR')^
execute procedure temp_create_edit_activity_right('MONEYLOCKEDSAFE_UW', 'MGMTSR')^

execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_MGMTSR', 'AG')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_MGMTSR', 'UW')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_MGMTSR', 'UWSR')^
execute procedure temp_create_view_activity_right('MONEYLOCKEDSAFE_MGMTSR', 'MGMTSR')^
execute procedure temp_create_edit_activity_right('MONEYLOCKEDSAFE_MGMTSR', 'MGMTSR')^
...
insert into applied_scripts (name, description, script_date)
     values ('201020ML03', 'RT-161 - auth level for money in locked safe', '2020-Sept-20');