...
execute procedure temp_add_custom_rule_without_notify('Prequal_HX', "{PREQUAL_WARNING}", "UNDERWRITING")^
execute procedure temp_add_custom_rule_with_notify('Prequal_HX', "{PREQUAL_WARNING}", "UNDERWRITING_NOTIFY")^
...
insert into applied_scripts (name, description, script_date)
     values ('210908DC01', 'MHM-944 add rule for HX prequal', '2021-Sep-08');
