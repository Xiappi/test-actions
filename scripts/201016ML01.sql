...
begin
    ...
    insert into custom_source_code (code_id, name, description, source_code, source_code_type_id)
         values (:var_custom_source_code_id, 'CalculateStampDuty', 'Failed to calculate Stamp Duty', '', :var_source_code_type_id);
    ...
    insert into rule_details (name, rule_detail_id, fail_message, code_id, rule_active, effective_book_id, expired_book_id, applies_to_applications, applies_to_changes, applies_to_renewals, applies_to_claims)
         values ('CalculateStampDuty', :var_rule_details_id, 'Failed to calculate Stamp Duty', :var_custom_source_code_id, 1, 1, 999999999, 1, 1, 1, 0);
...
insert into applied_scripts(name, description, script_date)
     values ("201016ML01", "BCSB-771 - stamp duty custom source code", "2020-10-15");