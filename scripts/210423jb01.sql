set term ^;
create procedure temp_hx_prequal
as
...
begin
  ...
  insert into questionnaire values(:qid, 'XX', 'HX', 'PREQUAL', :effdate, '31-DEC-9999', 'A', 'Clients/ArgusGI/Scripts/Questionnaire/PrequalQuestionnaire_HX_XX_v1.js');
...
execute procedure temp_hx_prequal^

commit^

drop procedure temp_hx_prequal^

commit^

insert into applied_scripts(name, description, script_date)
values ("210423jb01", "MHM-37 Add ArgusMT HX prequal questionnaire", "2021-APR-23")^
set term ;^
commit work;